<template lang="html">
  <div>
    <form @submit="onSubmit" action="index.html" method="post">
      <br>
      ...
      <div class="form-group row">
        ...
        <div class="col-10">
          <input class="form-control" type="number" v-model="price" name="price" value="">
        </div>
      </div>
      <div class="form-group row">
        <label for="example-url-input" class="col-2 col-form-label">Max participants</label>
        <div class="col-10">
          <input class="form-control" type="number" v-model="maxParticipants" name="maxParticipants" value="">
        </div>
      </div>
      <div class="form-group row">
        <label for="example-tel-input" class="col-2 col-form-label">Min participants</label>
        <div class="col-10">
          <input class="form-control" type="number" v-model="minParticipants" name="minParticipants" value="">
        </div>
      </div>
      <div class="form-group row">
        <label for="example-password-input" class="col-2 col-form-label">Min age</label>
        <div class="col-10">
          <input class="form-control" type="number" v-model="minAge" name="minAge" value="">
        </div>
      </div>
      <div class="form-group row">
        <label for="example-number-input" class="col-2 col-form-label">Duration hours</label>
        <div class="col-10">
          <input class="form-control" type="number" v-model="durationHours" name="durationHours" value="">
        </div>
      </div>
      <div class="form-group row">
        <label for="example-datetime-local-input" class="col-2 col-form-label">Duration minutes</label>
        <div class="col-10">
          <input class="form-control" type="number" v-model="durationMinutes" name="durationMinutes" value="">
        </div>
      </div>
      <div class="form-group row">
        <label for="example-date-input" class="col-2 col-form-label">Activity type</label>
        <div class="col-10">
          <input class="form-control" type="text" v-model="activityType" name="activityType" value="">
        </div>
      </div>
